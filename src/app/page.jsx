...
// // import { ShoppingCart, User, Search, Heart, Star, ArrowLeft, ArrowRight, Plus, Instagram, Facebook, Twitter, Mail, Phone, MapPin, Crown, Sparkles, Gift, Play, Pause, Volume2, Check, Award, Shield, Truck, Clock, ChevronDown, Menu, X } from 'lucide-react';
// // import MobileAccessoriesSections from './components/ModernLanding'
...
// //                 <div className="text-xl font-bold bg-gradient-to-r from-yellow-400 via-amber-500 to-yellow-600 bg-clip-text text-transparent font-arabic">KMS</div>
// //                 <div className="text-xs font-light text-yellow-400 tracking-[0.3em]">LUXURY</div>
// //               </div>
// //             </div>
...
// //                 { ar: 'الرئيسية', en: 'Home' },
// //                 { ar: 'المتجر', en: 'Shop' },
// //                 { ar: 'الأكثر مبيعاً', en: 'Best Sellers' },
// //                 { ar: 'من نحن', en: 'About' },
// //                 { ar: 'جديد', en: 'New' },
// //                 { ar: 'تواصل', en: 'Contact' }
// //               ].map((item, index) => (
// //                 <a key={index} href="#" className="relative px-3 py-1 text-xs text-black hover:text-gray-800 transition-all duration-300 group font-medium">
...
// //               <button className="p-2 text-gray-300 hover:text-yellow-400 transition-colors duration-300">
...
// //                 <span className="inline-block animate-slideUp font-arabic">اكتشف</span>{' '}
// //                 <span className="inline-block animate-slideUp" style={{animationDelay: '0.2s'}}>في</span>{' '}
// //                 <span className="inline-block italic bg-gradient-to-r from-yellow-400 via-amber-500 to-yellow-600 bg-clip-text text-transparent animate-slideUp" style={{animationDelay: '0.4s'}}>الأناقة</span>
// //               </h1>
// //               <h2 className="text-2xl md:text-4xl lg:text-6xl font-light text-gray-200 mb-8">
// //                 <span className="inline-block animate-slideUp">Indulge</span>{' '}
// //                 <span className="inline-block animate-slideUp" style={{animationDelay: '0.2s'}}>in</span>{' '}
// //                 <span className="inline-block italic bg-gradient-to-r from-yellow-400 via-amber-500 to-yellow-600 bg-clip-text text-transparent animate-slideUp" style={{animationDelay: '0.4s'}}>Luxury</span>
// //               </h2>
              
// //               <p className="text-lg md:text-xl text-gray-300 mb-10 animate-fadeIn leading-relaxed" style={{animationDelay: '0.6s'}}>
// //                 <span className="font-arabic text-yellow-400 block mb-2">اكتشف عطور فاخرة تحدد شخصيتك الفريدة</span>
// //                 Discover luxury fragrances that define your unique essence and elevate your personal style to extraordinary heights
// //               </p>
...
// //                         <span className="text-sm font-medium text-yellow-400 font-arabic block">العلامة</span>
// //                         <div className="text-xs text-gray-400">Brand</div>
// //                       </div>
// //                       <div className="group cursor-pointer hover:bg-yellow-500/10 p-3 rounded-lg transition-all duration-300 text-center border border-yellow-500/20 hover:border-yellow-500/40">
// //                         <Sparkles className="w-5 h-5 text-yellow-400 mx-auto mb-1" />
// //                         <span className="text-sm font-medium text-yellow-400 font-arabic block">النوع</span>
// //                         <div className="text-xs text-gray-400">Category</div>
// //                       </div>
// //                       <div className="group cursor-pointer hover:bg-yellow-500/10 p-3 rounded-lg transition-all duration-300 text-center border border-yellow-500/20 hover:border-yellow-500/40">
// //                         <Gift className="w-5 h-5 text-yellow-400 mx-auto mb-1" />
// //                         <span className="text-sm font-medium text-yellow-400 font-arabic block">الهدايا</span>
...
// //                       <span className="font-arabic">حصري</span> EXCLUSIVE
// //                     </div>
...
// //                       <h3 className="text-xl md:text-2xl font-bold text-white mb-2 font-arabic">عطر الملوك الفاخر</h3>
// //                       <p className="text-base md:text-lg text-gray-300 mb-2">Royal Luxury Essence</p>
...
// //                       </div>
// //                       <div className="text-base md:text-lg text-yellow-400 font-medium font-arabic">متاح حصرياً</div>
// //                       <p className="text-sm text-gray-400">Exclusively Available</p>
// //                     </div>
...
// //                       <span className="font-arabic hidden md:inline">شحن مجاني</span>
// //                     </div>
// //                     <div className="flex items-center space-x-1">
// //                       <Shield className="w-3 md:w-4 h-3 md:h-4 text-yellow-400" />
// //                       <span className="font-arabic hidden md:inline">ضمان الجودة</span>
// //                     </div>
// //                     <div className="flex items-center space-x-1">
...
// //                 {/* Main Bottle */}
// //                 <div className="absolute inset-0 bg-gradient-to-b from-gray-900/90 via-black/80 to-gray-900/90 rounded-3xl shadow-2xl shadow-yellow-500/20 group-hover:scale-105 transition-all duration-500 animate-float border border-yellow-500/30">
...
// //                       <img src="https://i.ibb.co/t1nkFy9/Screenshot-2025-08-16-005036.png" alt="Featured Perfume" className="relative h-32 md:h-40 w-24 md:w-32 object-cover rounded-xl shadow-lg border border-yellow-500/30" />
// //                     </div>
// //                   </div>
// //                 </div>
...
// //                   <div className="text-xs md:text-sm font-medium text-yellow-400 font-arabic">عنبر فاخر</div>
// //                   <div className="text-lg md:text-xl font-bold text-white">Luxury Amber</div>
...
// //                 <span className="font-arabic">اكتشف عالماً من</span>
// //                 <br />
// //                 Discover a world of 
// //                 <span className="block bg-gradient-to-r from-yellow-400 via-amber-500 to-yellow-600 bg-clip-text text-transparent italic">timeless luxury</span>
// //               </h2>
              
// //               <h3 className="text-xl md:text-2xl text-gray-300 mb-8 font-light">
// //                 <span className="font-arabic text-yellow-400">— عطور تعكس شخصيتك الفريدة وذوقك الشخصي</span>
// //                 <br />
// //                 — scents that reflect your unique essence and personal luxury style
// //               </h3>
              
// //               <p className="text-lg md:text-xl text-gray-400 mb-10 leading-relaxed">
// //                 <span className="font-arabic text-yellow-400 block mb-2">اكتشف منتجاتنا المختارة بعناية والأصيلة</span>
// //                 Discover our handpicked and timeless luxury products. Pick your signature scent that matches your personal taste, style and every special occasion.
// //               </p>
...
// //                     <span className="text-base md:text-lg font-arabic">شحن مجاني</span>
// //                     <span className="text-base md:text-lg">Free Shipping</span>
// //                   </span>
// //                 </button>
...
// //                       <span className="font-arabic">+50,000 عميل سعيد</span>
// //                     </p>
// //                     <div className="flex items-center space-x-1">
// //                       {[...Array(5)].map((_, i) => (
// //                         <Star key={i} className="w-4 h-4 text-yellow-400 fill-current" />
...
// //                 </h2>
// //                 <h3 className="text-2xl md:text-3xl font-light text-gray-300 mb-4">About KMS Luxury</h3>
...
// //                   <span className="font-arabic text-yellow-400 block mb-2">منذ عام 2010، نحن نصنع قصص العطور الفاخرة</span>
// //                   Since 2010, we've been crafting stories of luxury fragrance, combining traditional Middle Eastern perfumery with contemporary elegance to create scents that define moments and memories.
// //                 </p>
                
// //                 <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
// //                   <span className="font-arabic text-yellow-400 block mb-2">كل عطر يحكي قصة، كل زجاجة تحمل ذكرى</span>
// //                   Every fragrance tells a story, every bottle holds a memory. Our master perfumers blend the finest ingredients from around the world to create unique, luxurious scents.
// //                 </p>
...
// //                     <div className="text-sm text-gray-300 font-arabic">عطر فاخر</div>
// //                     <div className="text-xs text-gray-400">Luxury Fragrances</div>
// //                   </div>
// //                 </div>
// //               </div>
// //             </div>
...
// //                     {/* Brand Story */}
// //                     <div className="text-center">
// //                       <h3 className="text-2xl font-bold text-white mb-3 font-arabic">تراث من الفخامة</h3>
// //                       <p className="text-lg text-gray-300 mb-4">Legacy of Luxury</p>
// //                       <p className="text-sm text-yellow-400 font-arabic leading-relaxed">
// //                         "العطر هو الذاكرة غير المرئية"
// //                       </p>
// //                       <p className="text-xs text-gray-400 italic mt-2">
// //                         "Fragrance is the invisible memory"
// //                       </p>
// //                     </div>
...
// //                 </div>
// //                 <div>
// //                   <div className="text-2xl md:text-3xl font-bold font-arabic text-yellow-400">KMS</div>
// //                   <div className="text-base md:text-lg font-light text-gray-300 tracking-[0.3em]">LUXURY PERFUMES</div>
// //                 </div>
// //               </div>
              
// //               <p className="text-base md:text-lg text-gray-300 mb-8 leading-relaxed">
// //                 <span className="font-arabic text-yellow-400 block mb-2">اكتشف عالم العطور الفاخرة</span>
// //                 Discover the world of luxury fragrances. Every scent tells a story, every bottle holds a memory. Experience the art of fine perfumery with KMS Luxury.
// //               </p>
...
// //                   </div>
// //                   <span className="text-sm md:text-base text-gray-300">مرحباً@KMS.كوم - hello@kms.ae</span>
// //                 </div>
...
// //                   </div>
// //                   <span className="text-sm md:text-base text-gray-300">+971 4 123 4567 - دبي، الإمارات</span>
// //                 </div>
...
// //                   </div>
// //                   <span className="text-sm md:text-base text-gray-300 font-arabic">مول دبي، جادة الأزياء - Dubai Mall, Fashion Avenue</span>
// //                 </div>
// //               </div>
// //             </div>
...
// //                 <p className="font-arabic text-yellow-400 text-sm md:text-base">© 2024 KMS. جميع الحقوق محفوظة</p>
// //                 <p className="text-sm md:text-base">&copy; 2024 KMS Luxury Perfumes. All rights reserved. Crafted with ❤️ for fragrance connoisseurs worldwide.</p>
// //               </div>
...
// //                 <span className="text-xs text-gray-400 font-arabic">توصيل آمن</span>
// //               </div>
// //             </div>
// //           </div>
// //         </div>
...
//                 { ar: 'من نحن', en: 'About' },
//                 { ar: 'لماذا نحن', en: 'Why Us' },
//                 { ar: 'شركاؤنا', en: 'Partners' },
//                 { ar: 'تواصل', en: 'Contact' }
//               ].map((item, index) => (
//                 <a key={index} href="#" className="relative px-3 py-1 text-xs text-black hover:text-gray-800 transition-all duration-300 group font-medium">
//                   <div className="text-center">
